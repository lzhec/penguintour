...
$ALLOWED_DOMAINS = array('http://localhost:4200', 'http://penguintours.ru');
    ...
    && in_array($fromDomain, $ALLOWED_DOMAINS))
{
    ...
    header('Access-Control-Allow-Headers: Origin, X-Requested-With, Content-Type, Accept, Authorization, Content-Type, Content-Range, Content-Disposition, Content-Description');
}


     require_once($_SERVER['DOCUMENT_ROOT'] . 'data/htdocs/penguintour/src/assets/scripts/smartlid/php/config.php');
