...
(function($) {
	var defaults = {
		...
		navBtnIcon: '<img src="assets/scripts/smartlid/img/line-menu.svg" height="30" width="30" alt="">',

		//** Иконка кнопки, которая вызывает модальное окно с формой обратного звонка
		callFormBtnIcon: '<img src="assets/scripts/smartlid/img/phone.svg" height="30" width="30" alt="">',

		//** Иконка кнопки, которая вызывает модальное окно с формой отправки сообщения
		requestFormBtnIcon: '<img src="assets/scripts/smartlid/img/envelope.svg" height="30" width="30" alt="">',
		...
		callFormIcon: "assets/scripts/smartlid/img/call.svg",
		...
		requestFormIcon: "assets/scripts/smartlid/img/mail.svg",
	...
	var methods = {
		...
		sendMail: function(formid) {
			...
			$.ajax({
				url: "http://localhost:8000/appeal/",
				type: "POST",
				data: fd,
				processData: false,
				contentType: false,
